...
Este documento presenta los análisis del pre-piloto de la *Encuesta JUSMER Justicia y Merecimiento*. El objetivo de este insumo es orientar la toma de decisiones para la construcción de la versión final de la encuesta.
...
baterias <- list(
  ...
  "Experimento comodificación" = exp_comodifica,
  "Lucro" = lucro,
...
#### Experimento comodificación {.unnumbered}

```{r}
#| label: tbl-bateria-exp-comodifica
#| warning: false
#| tbl-cap: Tiempo de respuesta - Experimento comodificación

tabla_bateria("Experimento comodificación")
```
...
Los resultados demuestran, en primer lugar, que todas la tareas de asignación rondan el minuto de demora, a excepción de dos: el ejemplo, que se demora en promedio más de 2 minutos, y la última tarea, que se demora 38 segundos. Para la primera excepción, esto encuentra sentido en que los respondentes deben entender a cabalidad la tarea de asignación, lo cual requiere un esfuerzo de comprensión lectora y de atención. Para la segunda excepción esto puede deberse a la costumbre con el ejercicio después de varias repeticiones, por lo que requiere menos esfuerzo cognitivo en comparación a las primeras tareas (ver @tbl-bateria-conjoint).
...
#| warning: false
#| tbl-cap: Descriptivos - Experimento comodificación

tabla_desc_bateria("Experimento comodificación")
```
